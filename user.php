                ...
                <div class="card card-backend">
                    <div class="card-body">
                        <div class="mt-2">
                            ...
                            <input id="username_ed" value="<?php echo $show_user_id['username']; ?>" type="text" class="form-control" placeholder="Username">
                        </div>
                        <div class="mt-2">
                            <span>รหัสผ่าน</span>
                            <input id="password_ed" value="<?php echo $show_user_id['password']; ?>" type="text" class="form-control" placeholder="Password">
                        </div>
                        <div class="mt-2">
                            <span>อีเมล</span>
                            <input id="email_ed" value="<?php echo $show_user_id['email']; ?>" type="text" class="form-control" placeholder="Email">
                        </div>
                        <div class="mt-2">
                            <span>เบอร์</span>
                            <input id="phonenumber_ed" value="<?php echo $show_user_id['phonenumber']; ?>" type="text" class="form-control" placeholder="Phone number">
                        </div>
                        <div class="mt-2">
